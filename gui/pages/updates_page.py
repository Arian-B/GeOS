...
class UpdatesPage(QWidget):
    def __init__(self):
        ...
        self.action_status = QLabel("Action: --")
        self.action_status.setWordWrap(True)
        self.action_status.setStyleSheet(f"font-size: 13px; color: {theme.TEXT_SECONDARY};")
        self.layout.addWidget(self.action_status)
    ...
    def clear_pending(self):
        ...
        try:
            ...
            pass
        if removed_any:
            self.action_status.setText("Action: pending update files were cleared.")
        else:
            self.action_status.setText("Action: no pending update files found.")
        self.refresh()
